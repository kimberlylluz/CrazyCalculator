...
public class Display2 extends JPanel{
	...
	public Display2(Main main){
		...
		for(int i=0; i<12; i++){
		    ...
		    stackTField[i].setBounds(49, 116 + 20*i, 114, 20);
		...
		for(int i=0; i<12; i++){
			...
			queueTField[i].setBounds(280, 116 + 20*i, 114, 20);
		...
		for(int i=0; i<12; i++){
			...
			arrayTField[i].setBounds(512, 114 + 20*i, 114, 20);
		...
		for(int i=0; i<12; i++){
			...
			llistTField[i].setBounds(742, 114 + 20*i, 114, 20);
		...
		for(int i=0; i<12; i++){
		    ...
		    stackButton[i].setBounds(35, 109 + 20*i, 142, 42);
		...
		for(int i=0; i<12; i++){
		    ...
		    queueButton[i].setBounds(266, 109 + 20*i, 142, 42);
		...
		for(int i=0; i<12; i++){
		    ...
		    arrayButton[i].setBounds(498, 109 + 20*i, 142, 42);
		...
		for(int i=11; i>=0; i--){
		    ...
		    llistButton[i].setBounds(721, 106 + 20*i, 170, 60);
